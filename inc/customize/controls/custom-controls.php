<?php
/**
 * vw_personal_trainer Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class cricket_league_pro_Toggle_Switch_Custom_control extends WP_Customize_Control {
		...
		public function enqueue(){
			wp_enqueue_style( 'vw_landing_page_custom_controls_css', trailingslashit( get_template_directory_uri() ) . 'assets/css/customizer.css', array(), '1.0', 'all' );
		}
