...
$wp_customize->add_setting(
	'cricket_league_pro_slider_bgcolor',
	array(
		'default' => '',
...
$wp_customize->add_setting(
	'cricket_league_pro_slider_bgimage',
	array(
		'default' => '',
...
$wp_customize->add_setting(
	'cricket_league_pro_slider_player_img',
	array(
		'default' => '',
		'sanitize_callback' => 'esc_url_raw',
	)
...
$wp_customize->add_setting(
	'cricket_league_pro_slider_banner_ball',
	array(
		'default' => '',
		'sanitize_callback' => 'esc_url_raw',
	)
...
$wp_customize->add_setting(
	'cricket_league_pro_slider_heading',
	array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field'
	)
...
$wp_customize->add_setting(
	'cricket_league_pro_slider_heading_color_text',
	array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field'
	)
...
$wp_customize->add_control(
	...
	array(
		...
		'section' => 'cricket_league_pro_slider_sec',
		'setting' => 'cricket_league_pro_slider_heading_color_text',
		'type' => 'number'
	)
);
...
$wp_customize->add_setting(
	'cricket_league_pro_slider_text',
	array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field'
	)
...
$wp_customize->add_setting(
	'cricket_league_pro_slider_btn_bgcolor_one',
	array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	)
...
$wp_customize->add_setting(
	'cricket_league_pro_banner_button_icon',
	array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field'
	)
...
$wp_customize->add_control(
	new cricket_league_pro_Fontawesome_Icon_Chooser(
		...
		'cricket_league_pro_banner_button_icon',
		array(
			'settings' => 'cricket_league_pro_banner_button_icon',
			'section' => 'cricket_league_pro_slider_sec',
			'type' => 'icon',
...
$wp_customize->add_setting(
	'cricket_league_pro_cost_calcuator_shortcode',
	array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field'
	)
...
$wp_customize->add_setting(
	'cricket_league_pro_cost_calcuator_shortcode_link',
	array(
		'default' => '',
		'sanitize_callback' => 'sanitize_text_field'
	)
