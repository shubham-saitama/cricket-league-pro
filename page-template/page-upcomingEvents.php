    ...
    <div class="container">
        <div class="row">
            ...
            <div class="table-container">
                ...
                if ($query->have_posts()) {
                    echo '<table id="events-table">'; // Start the table
                    ...
                    while ($query->have_posts()) {
                        ...
                        if (count($teams) >= 2) {
                            ...
                            echo '<td>' . $venue . '</td>';
                            echo '<td>' . $time . '</td>';
                            echo '<td> <a href="' . get_permalink(get_page_by_title('Booking Form')) . '" class="theme-btn black">Book Now <i class="fa fa-hand-pointer-o"></i></a></td>';
                            echo '</tr>';
                        }
                        $i++;
                    }
