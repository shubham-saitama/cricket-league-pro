...
} elseif (get_theme_mod('cricket_league_pro_contactus_page_bgimage', '')) {
    $about_page_back = 'background-image:url(\'' . esc_url(get_theme_mod('cricket_league_pro_contactus_page_bgimage')) . '\')';
} else {
    $about_page_back = '';
}
$supportContactForm = get_theme_mod('cricket_league_pro_contactus_form');
            ...
            <div class="contactus-section">
                <div class="row">
                    <div class="support-contact-info col-lg-6" style="<?php echo $about_page_back_location ?>">
                        <h3><?php echo get_theme_mod('cricket_league_pro_contactus_contact_sectionheading'); ?></h3>
                        <p><?php echo get_theme_mod('cricket_league_pro_contactus_contact_section_desc'); ?></p>
                        <div class="map">
                            <iframe
                                src="https://maps.google.com/maps?q=<?php echo get_theme_mod('cricket_league_pro_contactus_latitude'); ?>,<?php echo get_theme_mod('cricket_league_pro_contactus_longitude'); ?>&hl=en&z=20&amp;output=embed"
                                frameborder="0">
                            </iframe>
                        </div>
                    </div>
