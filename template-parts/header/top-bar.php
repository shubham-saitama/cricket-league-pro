...
} elseif (get_theme_mod('cricket_league_pro_topbar_bgimage', '')) {
  $background_setting = 'background-image:url(\'' . esc_url(get_theme_mod('cricket_league_pro_topbar_bgimage')) . '\')';
} else {
  $background_setting = '';
}
$img_bg = get_theme_mod('cricket_league_pro_topbar_image_bg');
?>
    ...
    <div class="row justify-content-between">
      <div class="col-xl-6 col-lg-7 col-md-6 align-self-center topbar-left">
        <div class="topbar-address">
          <i class="<?php echo get_theme_mod('cricket_league_pro_topbar_left_icon_1'); ?>" aria-hidden="true"></i>
          <span class="topbar data"><?php echo get_theme_mod('cricket_league_pro_topbar_left_1'); ?></span>
        </div>
      </div>
