			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-6 col-md-6 col-sm-6">
						<?php if (get_theme_mod('home_automation_pro_footer_copyright_para') != ''): ?>
							<p class="">
								<i class="fa fa-copyright m-2"></i>
								<a target="_blank" href="https://www.vwthemes.com/"><?php echo esc_html(get_theme_mod('home_automation_pro_footer_copyright_para')); ?></a>
							</p>
						<?php endif; ?>
					</div>
					...
					<?php if (get_theme_mod('home_automation_pro_genral_section_show_scroll_top', true) == "1") { ?>
						<a href="javascript:" id="return-to-top"><i
								class="<?php echo esc_html(get_theme_mod('home_automation_pro_genral_section_show_scroll_top_icon')); ?>"></i><span
