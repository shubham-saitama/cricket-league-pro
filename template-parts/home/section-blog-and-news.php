 ...
 */
$about_section = get_theme_mod('home_automation_pro_latest_blog_and_news_enable');
if ('Disable' == $about_section) {
  return;
}
if (get_theme_mod('home_automation_pro_latest_blog_and_news_bgcolor', '')) {
  $about_backg = 'background-color:' . esc_attr(get_theme_mod('home_automation_pro_latest_blog_and_news_bgcolor', '')) . ';';
} elseif (get_theme_mod('home_automation_pro_latest_blog_and_news_bgimage', '')) {
  $about_backg = 'background-image:url(\'' . esc_url(get_theme_mod('home_automation_pro_latest_blog_and_news_bgimage')) . '\')';
} else {
  $about_backg = '';
}
$img_bg = get_theme_mod('home_automation_pro_latest_blog_and_news_bgimage');
      ...
      <div class="button-holder">
        <div class="heading-wrap">
          <div class="heading-tag">
            <?php echo get_theme_mod('home_automation_pro_blog_heading_tagline'); ?>
          </div>
          <h2><?php echo get_theme_mod('home_automation_pro_blog_heading'); ?></h2>
        </div>
        <a href="<?php echo get_permalink(get_page_by_title('Blog')); ?>" class="theme-btn black">
          <?php echo get_theme_mod('home_automation_pro_blog_view_all_settings'); ?><i
            class="<?php echo get_theme_mod('home_automation_pro_blog_button_icons') ?>"></i>
        </a>
      </div>
