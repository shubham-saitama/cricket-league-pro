...
$cricket_league_pro_header_title_color = get_theme_mod('cricket_league_pro_header_title_color');
...
$cricket_league_pro_site_frame_width = get_theme_mod('cricket_league_pro_site_frame_width');
$cricket_league_pro_site_frame_type = get_theme_mod('cricket_league_pro_site_frame_type');
$cricket_league_pro_site_frame_color = get_theme_mod('cricket_league_pro_site_frame_color');

/* ------------- Button Settings -------------- */

$cricket_league_pro_button_padding_top_bottom = get_theme_mod('cricket_league_pro_button_padding_top_bottom');
$cricket_league_pro_button_padding_left_right = get_theme_mod('cricket_league_pro_button_padding_left_right');
$cricket_league_pro_button_border_radius = get_theme_mod('cricket_league_pro_button_border_radius');
...
$cricket_league_pro_topbar_icon_color = get_theme_mod('cricket_league_pro_topbar_icon_color');


if ($cricket_league_pro_topbar_icon_color != false || $cricket_league_pro_topbar_left_icon_size != false) {
	$custom_css .= '.topbar-left i::before{';

	if ($cricket_league_pro_topbar_icon_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_topbar_icon_color) . ';';
	}
	if ($cricket_league_pro_topbar_left_icon_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_topbar_left_icon_size) . 'px;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_header_button_color = get_theme_mod('cricket_league_pro_header_button_color');
$cricket_league_pro_header_button_font_size = get_theme_mod('cricket_league_pro_header_button_font_size');
$cricket_league_pro_header_button_font_family = get_theme_mod('cricket_league_pro_header_button_font_family');
$cricket_league_pro_header_button_bg_color = get_theme_mod('cricket_league_pro_header_button_bg_color');

if ($cricket_league_pro_header_button_color != false || $cricket_league_pro_header_button_bg_color != false || $cricket_league_pro_header_button_font_family != false || $cricket_league_pro_header_button_font_size != false) {
	$custom_css .= '#site_top .top-bar-new-btn{';

	if ($cricket_league_pro_header_button_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_header_button_color) . ';';
	}
	if ($cricket_league_pro_header_button_bg_color != false) {
		$custom_css .= 'background: ' . esc_html($cricket_league_pro_header_button_bg_color) . ';';
	}
	if ($cricket_league_pro_header_button_font_family != false) {
		$custom_css .= 'font-family: ' . esc_html($cricket_league_pro_header_button_font_family) . ';';
	}
	if ($cricket_league_pro_header_button_font_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_header_button_font_size) . 'px;';
	}
	$custom_css .= '}';
}
...
if ($cricket_league_pro_social_icon_border_radius != false) {
	$custom_css .= '.socialbox a i, .social_widget a i{
			border-radius:' . esc_html($cricket_league_pro_social_icon_border_radius) . 'px;
		}';
}
...
if ($cricket_league_pro_headermenu_active_color != false) {
	$custom_css .= '.main-navigation .current-menu-item >a{';
	$custom_css .= 'color: ' . esc_html($cricket_league_pro_headermenu_active_color) . ' ;
		}';
}

if ($cricket_league_pro_head_search_icon_color != false) {
	$custom_css .= '.search-icon i{';
	$custom_css .= 'color: ' . esc_html($cricket_league_pro_head_search_icon_color) . ';
		}';
}


if ($cricket_league_pro_header_title_color != false || $cricket_league_pro_header_title_font_family != false) {
	$custom_css .= '#header .logo-text h2 a{';
	if ($cricket_league_pro_header_title_color != false)
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_header_title_color) . ';';
	if ($cricket_league_pro_header_title_font_family != false)
		$custom_css .= 'font-family: ' . esc_html($cricket_league_pro_header_title_font_family) . '; ';
	$custom_css .= '}';
}

if ($cricket_league_pro_header_title_font_size != false) {
	$custom_css .= '#header .logo-text h2 a{';
	$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_header_title_font_size) . 'px ;
		}';
}
if ($cricket_league_pro_header_subtitle_color != false || $cricket_league_pro_header_subtitle_font_family != false) {
	$custom_css .= '#header .logo-text p{';

	if ($cricket_league_pro_header_subtitle_color != false)
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_header_subtitle_color) . ';';
	if ($cricket_league_pro_header_subtitle_font_family != false)
		$custom_css .= 'font-family: ' . esc_html($cricket_league_pro_header_subtitle_font_family) . '; ';
	$custom_css .= '}';
}
if ($cricket_league_pro_header_subtitle_font_size != false) {
	$custom_css .= '#header .logo-text p{';
	$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_header_subtitle_font_size) . 'px  ;
		}';
}
...
if ($cricket_league_pro_header_menuhovercolor != false) {
	...
	$custom_css .= 'color: ' . esc_html($cricket_league_pro_header_menuhovercolor) . ' ;';
	$custom_css .= '}';
}
...
if ($cricket_league_pro_dropdownbg_itemcolor != false || $cricket_league_pro_dropdownbg_item_font_family != false || $cricket_league_pro_dropdownbg_item_font_size != false) {
	...
	if ($cricket_league_pro_dropdownbg_item_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_dropdownbg_item_font_size) . 'px;';
	}
	$custom_css .= '}';
}
if ($cricket_league_pro_dropdownbg_color != false) {
...
if ($cricket_league_pro_dropdownbg_item_hovercolor != false) {
	$custom_css .= '.main-navigation ul ul li:hover{
				color: ' . esc_html($cricket_league_pro_dropdownbg_item_hovercolor) . ';
			}';
}
$custom_css .= '}';
...
$theme_lay = get_theme_mod('cricket_league_pro_top_submenus_font_weight', '');
if ($theme_lay == '100') {
	$custom_css .= '#header #site-navigation ul ul a{';
...
//---------Text Transform---------------
$theme_lay = get_theme_mod('cricket_league_pro_top_submenus_text_transform', '');
...
if ($cricket_league_pro_top_submenus_bg_opacity_color != "") {
	$custom_css .= '#header #site-navigation ul li:hover > ul{
            opacity: ' . esc_html($cricket_league_pro_top_submenus_bg_opacity_color) . ';
        }';
}
if ($cricket_league_pro_top_submenus_box_shadow != false) {
	$custom_css .= '#header #site-navigation ul li:hover > ul{
            box-shadow: 0 0 3px ' . esc_html($cricket_league_pro_top_submenus_box_shadow) . ' #ccc;
        }';
}
...
if ($cricket_league_pro_header_res_background_bgcolor_one != false || $cricket_league_pro_header_res_background_bgcolor_two != false) {
	$custom_css .= '#sidebar1{';
	if ($cricket_league_pro_header_res_background_bgcolor_one != false || $cricket_league_pro_header_res_background_bgcolor_two != false)
		$custom_css .= 'background-image: linear-gradient(to right,' . esc_html($cricket_league_pro_header_res_background_bgcolor_one) . ',' . esc_html($cricket_league_pro_header_res_background_bgcolor_two) . ') ;';
	$custom_css .= '}';
}
if ($cricket_league_pro_header_res_menu_color != false) {
	$custom_css .= '.main-navigation ul li a,#sidebar1 .main-navigation .current_page_item>a{
				color: ' . esc_html($cricket_league_pro_header_res_menu_color) . ' ;
			}';
}
if ($cricket_league_pro_header_res_menu_font_family != false) {
	$custom_css .= '.main-navigation ul li a,#sidebar1 .main-navigation .current_page_item>a{
				font-family: ' . esc_html($cricket_league_pro_header_res_menu_font_family) . ' ;
			}';
}
if ($cricket_league_pro_header_res_menu_font_size != false) {
	$custom_css .= '.main-navigation ul li a,#sidebar1 .main-navigation .current_page_item>a{
				font-size: ' . esc_html($cricket_league_pro_header_res_menu_font_size) . 'px;
			}';
}

if ($cricket_league_pro_header_res_itemcolor != false) {
	$custom_css .= '#sidebar1 ul ul a{
				color: ' . esc_html($cricket_league_pro_header_res_itemcolor) . ' ;
			}';
}
if ($cricket_league_pro_header_res_item_font_size != false) {
	$custom_css .= '#sidebar1 ul ul a{
				font-size: ' . esc_html($cricket_league_pro_header_res_item_font_size) . 'px;
			}';
}
if ($cricket_league_pro_header_res_item_font_family != false) {
	$custom_css .= '#sidebar1 ul ul a{
				font-family: ' . esc_html($cricket_league_pro_header_res_item_font_family) . ' ;
			}';
}
if ($cricket_league_pro_res_open_menu_icon_color != false) {
	$custom_css .= '.toggle-nav i{
				color: ' . esc_html($cricket_league_pro_res_open_menu_icon_color) . ';
			}';
}
if ($cricket_league_pro_res_open_menu_icon_font_size != false) {
	$custom_css .= '.toggle-nav i{
				font-size: ' . esc_html($cricket_league_pro_res_open_menu_icon_font_size) . 'px;
			}';
}
if ($cricket_league_pro_header_close_iconcolor != false) {
	$custom_css .= '#close_nav i{
				color: ' . esc_html($cricket_league_pro_header_close_iconcolor) . ';
			}';
}
if ($cricket_league_pro_header_close_icon_font_size != false) {
	$custom_css .= '#close_nav i{
				font-size: ' . esc_html($cricket_league_pro_header_close_icon_font_size) . 'px ;
			}';
}
$custom_css .= '}';
...
$custom_css .= '#slider::after{';

$custom_css .= 'background-image:url( ' . get_template_directory_uri() . '/assets/new-images/slider/hover-design.png' . ');';

$custom_css .= '}';


$custom_css .= '#slider::before{';

$custom_css .= 'background-image:url( ' . get_template_directory_uri() . '/assets/new-images/slider/design1.png' . ');';

$custom_css .= '}';

$custom_css .= 'section#testimonials h2::before {';

$custom_css .= 'background-image:url( ' . get_theme_mod('cricket_league_pro_testimonial_floating_image') . ');';
...
$cricket_league_pro_slider_nav_color = get_theme_mod('cricket_league_pro_slider_nav_color');
$cricket_league_pro_slider_nav_font_size = get_theme_mod('cricket_league_pro_slider_nav_font_size');

if ($cricket_league_pro_slider_nav_color != false || $cricket_league_pro_slider_nav_font_size != false) {
	$custom_css .= '#slider .fas.fa-angle-left, #slider .fas.fa-angle-right, #gallery .owl-nav i{';
	if ($cricket_league_pro_slider_nav_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_slider_nav_color) . ';';
	}
	if ($cricket_league_pro_slider_nav_font_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_slider_nav_font_size) . 'px;';
	}
}

$cricket_league_pro_slider_nav_bg_color = get_theme_mod('cricket_league_pro_slider_nav_bg_color');
$cricket_league_pro_slider_nav_border_color = get_theme_mod('cricket_league_pro_slider_nav_border_color');

if ($cricket_league_pro_slider_nav_bg_color != false || $cricket_league_pro_slider_nav_border_color != false) {
	$custom_css .= '#slider .owl-carousel .owl-nav .owl-prev, #slider .owl-carousel .owl-nav .owl-next{';
	if ($cricket_league_pro_slider_nav_bg_color != false) {
		$custom_css .= 'background: ' . esc_html($cricket_league_pro_slider_nav_bg_color) . ';';
	}
	if ($cricket_league_pro_slider_nav_border_color != false) {
		$custom_css .= 'border-color: ' . esc_html($cricket_league_pro_slider_nav_border_color) . ';';
	}
}

$cricket_league_pro_slider_dots_color = get_theme_mod('cricket_league_pro_slider_dots_color');
$cricket_league_pro_slider_dots_active_color = get_theme_mod('cricket_league_pro_slider_dots_active_color');

if ($cricket_league_pro_slider_dots_active_color != false) {
	$custom_css .= '#slider button.owl-dot.active{';
	if ($cricket_league_pro_slider_dots_active_color != false) {
		$custom_css .= 'background: ' . esc_html($cricket_league_pro_slider_dots_active_color) . ';';
	}
}

if ($cricket_league_pro_slider_dots_color != false) {
	$custom_css .= '#slider button.owl-dot{';
	if ($cricket_league_pro_slider_dots_color != false) {
		$custom_css .= 'background: ' . esc_html($cricket_league_pro_slider_dots_color) . ';';
	}
}

// Services Section 

$cricket_league_pro_our_services_sub_heading_color = get_theme_mod('cricket_league_pro_our_services_sub_heading_color');
$cricket_league_pro_our_services_sub_heading_font_size = get_theme_mod('cricket_league_pro_our_services_sub_heading_font_size');
$cricket_league_pro_our_services_sub_heading_font_family = get_theme_mod('cricket_league_pro_our_services_sub_heading_font_family');
$cricket_league_pro_our_services_sub_heading_font_weight = get_theme_mod('cricket_league_pro_our_services_sub_heading_font_weight');


if ($cricket_league_pro_our_services_sub_heading_color != false || $cricket_league_pro_our_services_sub_heading_font_family != false || $cricket_league_pro_our_services_sub_heading_font_size != false || $cricket_league_pro_our_services_sub_heading_font_weight != false) {
	$custom_css .= 'section#services-us .heading-tagline{';
	if ($cricket_league_pro_our_services_sub_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_services_sub_heading_color) . ' ;';
	}
	if ($cricket_league_pro_our_services_sub_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_our_services_sub_heading_font_family) . ';';
	}
	if ($cricket_league_pro_our_services_sub_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_our_services_sub_heading_font_size) . 'px;';
	}
	if ($cricket_league_pro_our_services_sub_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_our_services_sub_heading_font_weight) . ';';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_our_services_heading_color = get_theme_mod('cricket_league_pro_our_services_heading_color');
$cricket_league_pro_our_services_heading_font_size = get_theme_mod('cricket_league_pro_our_services_heading_font_size');
$cricket_league_pro_our_services_heading_font_family = get_theme_mod('cricket_league_pro_our_services_heading_font_family');
$cricket_league_pro_our_services_heading_font_weight = get_theme_mod('cricket_league_pro_our_services_heading_font_weight');


if ($cricket_league_pro_our_services_heading_color != false || $cricket_league_pro_our_services_heading_font_family != false || $cricket_league_pro_our_services_heading_font_size != false || $cricket_league_pro_our_services_heading_font_weight != false) {
	$custom_css .= 'section#services-us h2{';
	if ($cricket_league_pro_our_services_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_services_heading_color) . ' ;';
	}
	if ($cricket_league_pro_our_services_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_our_services_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_our_services_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_our_services_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_our_services_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_our_services_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_our_services_slide_title_color = get_theme_mod('cricket_league_pro_our_services_slide_title_color');
$cricket_league_pro_our_services_slide_title_font_size = get_theme_mod('cricket_league_pro_our_services_slide_title_font_size');
$cricket_league_pro_our_services_slide_title_font_family = get_theme_mod('cricket_league_pro_our_services_slide_title_font_family');
$cricket_league_pro_our_services_slide_title_font_weight = get_theme_mod('cricket_league_pro_our_services_slide_title_font_weight');


if ($cricket_league_pro_our_services_slide_title_color != false || $cricket_league_pro_our_services_slide_title_font_family != false || $cricket_league_pro_our_services_slide_title_font_size != false || $cricket_league_pro_our_services_slide_title_font_weight != false) {
	$custom_css .= '.service-card h3{';
	if ($cricket_league_pro_our_services_slide_title_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_services_slide_title_color) . ' ;';
	}
	if ($cricket_league_pro_our_services_slide_title_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_our_services_slide_title_font_family) . ' ;';
	}
	if ($cricket_league_pro_our_services_slide_title_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_our_services_slide_title_font_size) . 'px ;';
	}
	if ($cricket_league_pro_our_services_slide_title_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_our_services_slide_title_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_our_services_icon_border_color = get_theme_mod('cricket_league_pro_our_services_icon_border_color');



if ($cricket_league_pro_our_services_icon_border_color != false) {
	$custom_css .= '.service-card .services-icon{';
	if ($cricket_league_pro_our_services_icon_border_color != false) {
		$custom_css .= 'border-color: ' . esc_html($cricket_league_pro_our_services_icon_border_color) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_our_services_icon_hover_color = get_theme_mod('cricket_league_pro_our_services_icon_hover_color');


if ($cricket_league_pro_our_services_icon_hover_color != false) {
	$custom_css .= '.service-card:hover::before,.service-card:hover .services-icon{';
	if ($cricket_league_pro_our_services_icon_hover_color != false) {
		$custom_css .= 'background-color: ' . esc_html($cricket_league_pro_our_services_icon_hover_color) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_steps_section_decoration = get_theme_mod('cricket_league_pro_steps_section_decoration');

if ($cricket_league_pro_steps_section_decoration != false) {
	$custom_css .= '#steps_sec-us::after{';
	if ($cricket_league_pro_steps_section_decoration != false) {
		$custom_css .= 'background-image:url(' . esc_html($cricket_league_pro_steps_section_decoration) . ');';
	}
	$custom_css .= '}';
}

$cricket_league_pro_steps_section_heading_tagline_color = get_theme_mod('cricket_league_pro_steps_section_heading_tagline_color');
$cricket_league_pro_steps_section_heading_tagline_font_size = get_theme_mod('cricket_league_pro_steps_section_heading_tagline_font_size');
$cricket_league_pro_steps_section_heading_tagline_font_family = get_theme_mod('cricket_league_pro_steps_section_heading_tagline_font_family');
$cricket_league_pro_steps_section_heading_tagline_font_weight = get_theme_mod('cricket_league_pro_steps_section_heading_tagline_font_weight');


if ($cricket_league_pro_steps_section_heading_tagline_color != false || $cricket_league_pro_steps_section_heading_tagline_font_family != false || $cricket_league_pro_steps_section_heading_tagline_font_size != false || $cricket_league_pro_steps_section_heading_tagline_font_weight != false) {
	$custom_css .= 'section#steps_sec-us .heading-tagline{';
	if ($cricket_league_pro_steps_section_heading_tagline_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_steps_section_heading_tagline_color) . ' ;';
	}
	if ($cricket_league_pro_steps_section_heading_tagline_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_steps_section_heading_tagline_font_family) . ' ;';
	}
	if ($cricket_league_pro_steps_section_heading_tagline_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_steps_section_heading_tagline_font_size) . 'px ;';
	}
	if ($cricket_league_pro_steps_section_heading_tagline_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_steps_section_heading_tagline_font_weight) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_steps_section_heading_color = get_theme_mod('cricket_league_pro_steps_section_heading_color');
$cricket_league_pro_steps_section_heading_font_size = get_theme_mod('cricket_league_pro_steps_section_heading_font_size');
$cricket_league_pro_steps_section_heading_font_family = get_theme_mod('cricket_league_pro_steps_section_heading_font_family');
$cricket_league_pro_steps_section_heading_font_weight = get_theme_mod('cricket_league_pro_steps_section_heading_font_weight');


if ($cricket_league_pro_steps_section_heading_color != false || $cricket_league_pro_steps_section_heading_font_family != false || $cricket_league_pro_steps_section_heading_font_size != false || $cricket_league_pro_steps_section_heading_font_weight != false) {
	$custom_css .= 'section#steps_sec-us h2{';
	if ($cricket_league_pro_steps_section_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_steps_section_heading_color) . ' ;';
	}
	if ($cricket_league_pro_steps_section_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_steps_section_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_steps_section_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_steps_section_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_steps_section_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_steps_section_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_pricing_section_heading_tag_color = get_theme_mod('cricket_league_pro_pricing_section_heading_tag_color');
$cricket_league_pro_pricing_section_heading_tag_font_size = get_theme_mod('cricket_league_pro_pricing_section_heading_tag_font_size');
$cricket_league_pro_pricing_section_heading_tag_font_family = get_theme_mod('cricket_league_pro_pricing_section_heading_tag_font_family');
$cricket_league_pro_pricing_section_heading_tag_font_weight = get_theme_mod('cricket_league_pro_pricing_section_heading_tag_font_weight');


if ($cricket_league_pro_pricing_section_heading_tag_color != false || $cricket_league_pro_pricing_section_heading_tag_font_family != false || $cricket_league_pro_pricing_section_heading_tag_font_size != false || $cricket_league_pro_pricing_section_heading_tag_font_weight != false) {
	$custom_css .= 'section#pricing_sec-us .heading-tagline{';
	if ($cricket_league_pro_pricing_section_heading_tag_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_pricing_section_heading_tag_color) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_heading_tag_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_pricing_section_heading_tag_font_family) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_heading_tag_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_pricing_section_heading_tag_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_pricing_section_heading_tag_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_pricing_section_heading_tag_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_pricing_section_heading_color = get_theme_mod('cricket_league_pro_pricing_section_heading_color');
$cricket_league_pro_pricing_section_heading_font_size = get_theme_mod('cricket_league_pro_pricing_section_heading_font_size');
$cricket_league_pro_pricing_section_heading_font_family = get_theme_mod('cricket_league_pro_pricing_section_heading_font_family');
$cricket_league_pro_pricing_section_heading_font_weight = get_theme_mod('cricket_league_pro_pricing_section_heading_font_weight');


if ($cricket_league_pro_pricing_section_heading_color != false || $cricket_league_pro_pricing_section_heading_font_family != false || $cricket_league_pro_pricing_section_heading_font_size != false || $cricket_league_pro_pricing_section_heading_font_weight != false) {
	$custom_css .= 'section#pricing_sec-us h2{';
	if ($cricket_league_pro_pricing_section_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_pricing_section_heading_color) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_pricing_section_heading_font_family) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_pricing_section_heading_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_pricing_section_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_pricing_section_heading_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_step_title_heading_color = get_theme_mod('cricket_league_pro_step_title_heading_color');
$cricket_league_pro_step_title_heading_font_size = get_theme_mod('cricket_league_pro_step_title_heading_font_size');
$cricket_league_pro_step_title_heading_font_family = get_theme_mod('cricket_league_pro_step_title_heading_font_family');
$cricket_league_pro_step_title_heading_font_weight = get_theme_mod('cricket_league_pro_step_title_heading_font_weight');


if ($cricket_league_pro_step_title_heading_color != false || $cricket_league_pro_step_title_heading_font_family != false || $cricket_league_pro_step_title_heading_font_size != false || $cricket_league_pro_step_title_heading_font_weight != false) {
	$custom_css .= '.step-text h4{';
	if ($cricket_league_pro_step_title_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_step_title_heading_color) . ' ;';
	}
	if ($cricket_league_pro_step_title_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_step_title_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_step_title_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_step_title_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_step_title_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_step_title_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_step_desc_heading_color = get_theme_mod('cricket_league_pro_step_desc_heading_color');
$cricket_league_pro_step_desc_heading_font_size = get_theme_mod('cricket_league_pro_step_desc_heading_font_size');
$cricket_league_pro_step_desc_heading_font_family = get_theme_mod('cricket_league_pro_step_desc_heading_font_family');
$cricket_league_pro_step_desc_heading_font_weight = get_theme_mod('cricket_league_pro_step_desc_heading_font_weight');


if ($cricket_league_pro_step_desc_heading_color != false || $cricket_league_pro_step_desc_heading_font_family != false || $cricket_league_pro_step_desc_heading_font_size != false || $cricket_league_pro_step_desc_heading_font_weight != false) {
	$custom_css .= '.top-step .step-text p,.step-text p{';
	if ($cricket_league_pro_step_desc_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_step_desc_heading_color) . ' ;';
	}
	if ($cricket_league_pro_step_desc_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_step_desc_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_step_desc_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_step_desc_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_step_desc_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_step_desc_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_service_attribute_title_color = get_theme_mod('cricket_league_pro_service_attribute_title_color');
$cricket_league_pro_service_attribute_title_font_size = get_theme_mod('cricket_league_pro_service_attribute_title_font_size');
$cricket_league_pro_service_attribute_title_font_family = get_theme_mod('cricket_league_pro_service_attribute_title_font_family');
$cricket_league_pro_service_attribute_title_font_weight = get_theme_mod('cricket_league_pro_service_attribute_title_font_weight');


if ($cricket_league_pro_service_attribute_title_color != false || $cricket_league_pro_service_attribute_title_font_family != false || $cricket_league_pro_service_attribute_title_font_size != false || $cricket_league_pro_service_attribute_title_font_weight != false) {
	$custom_css .= '.service-heading h3{';
	if ($cricket_league_pro_service_attribute_title_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_service_attribute_title_color) . ' ;';
	}
	if ($cricket_league_pro_service_attribute_title_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_service_attribute_title_font_family) . ' ;';
	}
	if ($cricket_league_pro_service_attribute_title_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_service_attribute_title_font_size) . 'px ;';
	}
	if ($cricket_league_pro_service_attribute_title_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_service_attribute_title_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_corner_png = get_theme_mod('cricket_league_pro_corner_png');

if ($cricket_league_pro_corner_png != false) {
	$custom_css .= '.pricing-card::after,.faq-img-wrapper::after,.GetInTouch::after,.customer-image::after{';
	if ($cricket_league_pro_corner_png != false) {
		$custom_css .= 'background-image:url(' . esc_html($cricket_league_pro_corner_png) . ');';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_faq_service_attribute_title_color = get_theme_mod('cricket_league_pro_faq_service_attribute_title_color');
$cricket_league_pro_faq_service_attribute_title_font_size = get_theme_mod('cricket_league_pro_faq_service_attribute_title_font_size');
$cricket_league_pro_faq_service_attribute_title_font_family = get_theme_mod('cricket_league_pro_faq_service_attribute_title_font_family');
$cricket_league_pro_faq_service_attribute_title_font_weight = get_theme_mod('cricket_league_pro_faq_service_attribute_title_font_weight');


if ($cricket_league_pro_faq_service_attribute_title_color != false || $cricket_league_pro_faq_service_attribute_title_font_family != false || $cricket_league_pro_faq_service_attribute_title_font_size != false || $cricket_league_pro_faq_service_attribute_title_font_weight != false) {
	$custom_css .= 'p.service-attribute-title{';
	if ($cricket_league_pro_faq_service_attribute_title_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_faq_service_attribute_title_color) . ' ;';
	}
	if ($cricket_league_pro_faq_service_attribute_title_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_faq_service_attribute_title_font_family) . ' ;';
	}
	if ($cricket_league_pro_faq_service_attribute_title_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_faq_service_attribute_title_font_size) . 'px ;';
	}
	if ($cricket_league_pro_faq_service_attribute_title_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_faq_service_attribute_title_font_weight) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_faq_service_attribute_description_color = get_theme_mod('cricket_league_pro_faq_service_attribute_description_color');
$cricket_league_pro_faq_service_attribute_description_font_size = get_theme_mod('cricket_league_pro_faq_service_attribute_description_font_size');
$cricket_league_pro_faq_service_attribute_description_font_family = get_theme_mod('cricket_league_pro_faq_service_attribute_description_font_family');
$cricket_league_pro_faq_service_attribute_description_font_weight = get_theme_mod('cricket_league_pro_faq_service_attribute_description_font_weight');


if ($cricket_league_pro_faq_service_attribute_description_color != false || $cricket_league_pro_faq_service_attribute_description_font_family != false || $cricket_league_pro_faq_service_attribute_description_font_size != false || $cricket_league_pro_faq_service_attribute_description_font_weight != false) {
	$custom_css .= 'p.service-attribute-desc{';
	if ($cricket_league_pro_faq_service_attribute_description_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_faq_service_attribute_description_color) . ' ;';
	}
	if ($cricket_league_pro_faq_service_attribute_description_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_faq_service_attribute_description_font_family) . ' ;';
	}
	if ($cricket_league_pro_faq_service_attribute_description_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_faq_service_attribute_description_font_size) . 'px ;';
	}
	if ($cricket_league_pro_faq_service_attribute_description_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_faq_service_attribute_description_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
$cricket_league_pro_pricing_section_section_paragraph_color = get_theme_mod('cricket_league_pro_pricing_section_section_paragraph_color');
$cricket_league_pro_pricing_section_section_paragraph_font_size = get_theme_mod('cricket_league_pro_pricing_section_section_paragraph_font_size');
$cricket_league_pro_pricing_section_section_paragraph_font_family = get_theme_mod('cricket_league_pro_pricing_section_section_paragraph_font_family');
$cricket_league_pro_pricing_section_section_paragraph_font_weight = get_theme_mod('cricket_league_pro_pricing_section_section_paragraph_font_weight');


if ($cricket_league_pro_pricing_section_section_paragraph_color != false || $cricket_league_pro_pricing_section_section_paragraph_font_family != false || $cricket_league_pro_pricing_section_section_paragraph_font_size != false || $cricket_league_pro_pricing_section_section_paragraph_font_weight != false) {
	$custom_css .= '.pricing-right p{';
	if ($cricket_league_pro_pricing_section_section_paragraph_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_pricing_section_section_paragraph_color) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_section_paragraph_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_pricing_section_section_paragraph_font_family) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_section_paragraph_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_pricing_section_section_paragraph_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_pricing_section_section_paragraph_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_pricing_section_section_paragraph_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_pricing_section_points_color = get_theme_mod('cricket_league_pro_pricing_section_points_color');
$cricket_league_pro_pricing_section_points_font_size = get_theme_mod('cricket_league_pro_pricing_section_points_font_size');
$cricket_league_pro_pricing_section_points_font_family = get_theme_mod('cricket_league_pro_pricing_section_points_font_family');
$cricket_league_pro_pricing_section_points_font_weight = get_theme_mod('cricket_league_pro_pricing_section_points_font_weight');


if ($cricket_league_pro_pricing_section_points_color != false || $cricket_league_pro_pricing_section_points_font_family != false || $cricket_league_pro_pricing_section_points_font_size != false || $cricket_league_pro_pricing_section_points_font_weight != false) {
	$custom_css .= 'p.PriceCheck{';
	if ($cricket_league_pro_pricing_section_points_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_pricing_section_points_color) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_points_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_pricing_section_points_font_family) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_points_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_pricing_section_points_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_pricing_section_points_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_pricing_section_points_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_pricing_section_package_name_color = get_theme_mod('cricket_league_pro_pricing_section_package_name_color');
$cricket_league_pro_pricing_section_package_name_font_size = get_theme_mod('cricket_league_pro_pricing_section_package_name_font_size');
$cricket_league_pro_pricing_section_package_name_font_family = get_theme_mod('cricket_league_pro_pricing_section_package_name_font_family');
$cricket_league_pro_pricing_section_package_name_font_weight = get_theme_mod('cricket_league_pro_pricing_section_package_name_font_weight');


if ($cricket_league_pro_pricing_section_package_name_color != false || $cricket_league_pro_pricing_section_package_name_font_family != false || $cricket_league_pro_pricing_section_package_name_font_size != false || $cricket_league_pro_pricing_section_package_name_font_weight != false) {
	$custom_css .= '.pricing-card.dark .pack-name h4,.pack-name h4{';
	if ($cricket_league_pro_pricing_section_package_name_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_pricing_section_package_name_color) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_package_name_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_pricing_section_package_name_font_family) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_package_name_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_pricing_section_package_name_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_pricing_section_package_name_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_pricing_section_package_name_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_pricing_section_regular_package_name_color = get_theme_mod('cricket_league_pro_pricing_section_regular_package_name_color');

if ($cricket_league_pro_pricing_section_regular_package_name_color != false) {
	$custom_css .= '.pack-name h4,.pack-price,p.PriceCheck{';
	if ($cricket_league_pro_pricing_section_regular_package_name_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_pricing_section_regular_package_name_color) . ' !important;';
	}
	$custom_css .= '}';
}
$cricket_league_pro_pricing_section_package_text_color = get_theme_mod('cricket_league_pro_pricing_section_package_text_color');

if ($cricket_league_pro_pricing_section_package_text_color != false) {
	$custom_css .= '.pricing-card.dark .pack-name,.pricing-card.dark .pack-price,.pricing-card.dark p.PriceCheck{';
	if ($cricket_league_pro_pricing_section_package_text_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_pricing_section_package_text_color) . ' !important;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_pricing_section_button_text_color = get_theme_mod('cricket_league_pro_pricing_section_button_text_color');
$cricket_league_pro_pricing_section_button_text_font_size = get_theme_mod('cricket_league_pro_pricing_section_button_text_font_size');
$cricket_league_pro_pricing_section_button_text_font_family = get_theme_mod('cricket_league_pro_pricing_section_button_text_font_family');
$cricket_league_pro_pricing_section_button_text_font_weight = get_theme_mod('cricket_league_pro_pricing_section_button_text_font_weight');


if ($cricket_league_pro_pricing_section_button_text_color != false || $cricket_league_pro_pricing_section_button_text_font_family != false || $cricket_league_pro_pricing_section_button_text_font_size != false || $cricket_league_pro_pricing_section_button_text_font_weight != false) {
	$custom_css .= 'section#pricing_sec-us a.submit-btn{';
	if ($cricket_league_pro_pricing_section_button_text_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_pricing_section_button_text_color) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_button_text_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_pricing_section_button_text_font_family) . ' !important;';
	}
	if ($cricket_league_pro_pricing_section_button_text_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_pricing_section_button_text_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_pricing_section_button_text_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_pricing_section_button_text_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_pricing_pointtion_bgimage = get_theme_mod('cricket_league_pro_pricing_pointtion_bgimage');

if ($cricket_league_pro_pricing_pointtion_bgimage != false) {
	$custom_css .= '.pricing-card{';
	if ($cricket_league_pro_pricing_pointtion_bgimage != false) {
		$custom_css .= 'background-color: ' . esc_html($cricket_league_pro_pricing_pointtion_bgimage) . ';';
	}
	$custom_css .= '}';
}

$cricket_league_pro_pricing_pointtion_bgimage_regular = get_theme_mod('cricket_league_pro_pricing_pointtion_bgimage_regular');

if ($cricket_league_pro_pricing_pointtion_bgimage_regular != false) {
	$custom_css .= '.pricing-card.dark{';
	if ($cricket_league_pro_pricing_pointtion_bgimage_regular != false) {
		$custom_css .= 'background-color: ' . esc_html($cricket_league_pro_pricing_pointtion_bgimage_regular) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_video_link_disable = get_theme_mod('cricket_league_pro_video_link_disable');

if ($cricket_league_pro_video_link_disable != 0) {
	$custom_css .= '.choose-sec-vid-link{';
...
if ($cricket_league_pro_testimonial_heading_tag_color != false || $cricket_league_pro_testimonial_heading_tag_font_family != false || $cricket_league_pro_testimonial_heading_tag_font_size != false || $cricket_league_pro_testimonial_heading_tag_font_weight != false) {
	$custom_css .= 'section#testimonials .heading-tagline{';
...
if ($cricket_league_pro_testimonial_heading_color != false || $cricket_league_pro_testimonial_heading_font_family != false || $cricket_league_pro_testimonial_heading_font_size != false || $cricket_league_pro_testimonial_heading_font_weight != false) {
	$custom_css .= 'section#testimonials h2{';
...
$cricket_league_pro_our_team_heading_tag_color = get_theme_mod('cricket_league_pro_our_team_heading_tag_color');
$cricket_league_pro_our_team_heading_tag_font_size = get_theme_mod('cricket_league_pro_our_team_heading_tag_font_size');
$cricket_league_pro_our_team_heading_tag_font_family = get_theme_mod('cricket_league_pro_our_team_heading_tag_font_family');
$cricket_league_pro_our_team_heading_tag_font_weight = get_theme_mod('cricket_league_pro_our_team_heading_tag_font_weight');


if ($cricket_league_pro_our_team_heading_tag_color != false || $cricket_league_pro_our_team_heading_tag_font_family != false || $cricket_league_pro_our_team_heading_tag_font_size != false || $cricket_league_pro_our_team_heading_tag_font_weight != false) {
	$custom_css .= 'section#Our-team .heading-tagline{';
	if ($cricket_league_pro_our_team_heading_tag_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_team_heading_tag_color) . ' ;';
	}
	if ($cricket_league_pro_our_team_heading_tag_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_our_team_heading_tag_font_family) . ' ;';
	}
	if ($cricket_league_pro_our_team_heading_tag_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_our_team_heading_tag_font_size) . 'px ;';
	}
	if ($cricket_league_pro_our_team_heading_tag_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_our_team_heading_tag_font_weight) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_our_team_heading_color = get_theme_mod('cricket_league_pro_our_team_heading_color');
$cricket_league_pro_our_team_heading_font_size = get_theme_mod('cricket_league_pro_our_team_heading_font_size');
$cricket_league_pro_our_team_heading_font_family = get_theme_mod('cricket_league_pro_our_team_heading_font_family');
$cricket_league_pro_our_team_heading_font_weight = get_theme_mod('cricket_league_pro_our_team_heading_font_weight');


if ($cricket_league_pro_our_team_heading_color != false || $cricket_league_pro_our_team_heading_font_family != false || $cricket_league_pro_our_team_heading_font_size != false || $cricket_league_pro_our_team_heading_font_weight != false) {
	$custom_css .= 'section#Our-team h2{';
	if ($cricket_league_pro_our_team_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_team_heading_color) . ' ;';
	}
	if ($cricket_league_pro_our_team_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_our_team_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_our_team_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_our_team_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_our_team_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_our_team_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_our_team_team_member_color = get_theme_mod('cricket_league_pro_our_team_team_member_color');
$cricket_league_pro_our_team_team_member_font_size = get_theme_mod('cricket_league_pro_our_team_team_member_font_size');
$cricket_league_pro_our_team_team_member_font_family = get_theme_mod('cricket_league_pro_our_team_team_member_font_family');
$cricket_league_pro_our_team_team_member_font_weight = get_theme_mod('cricket_league_pro_our_team_team_member_font_weight');


if ($cricket_league_pro_our_team_team_member_color != false || $cricket_league_pro_our_team_team_member_font_family != false || $cricket_league_pro_our_team_team_member_font_size != false || $cricket_league_pro_our_team_team_member_font_weight != false) {
	$custom_css .= '.card-row h3{';
	if ($cricket_league_pro_our_team_team_member_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_team_team_member_color) . ' ;';
	}
	if ($cricket_league_pro_our_team_team_member_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_our_team_team_member_font_family) . ' ;';
	}
	if ($cricket_league_pro_our_team_team_member_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_our_team_team_member_font_size) . 'px ;';
	}
	if ($cricket_league_pro_our_team_team_member_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_our_team_team_member_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_our_team_designation_color = get_theme_mod('cricket_league_pro_our_team_designation_color');
$cricket_league_pro_our_team_designation_font_size = get_theme_mod('cricket_league_pro_our_team_designation_font_size');
$cricket_league_pro_our_team_designation_font_family = get_theme_mod('cricket_league_pro_our_team_designation_font_family');
$cricket_league_pro_our_team_designation_font_weight = get_theme_mod('cricket_league_pro_our_team_designation_font_weight');


if ($cricket_league_pro_our_team_designation_color != false || $cricket_league_pro_our_team_designation_font_family != false || $cricket_league_pro_our_team_designation_font_size != false || $cricket_league_pro_our_team_designation_font_weight != false) {
	$custom_css .= 'p.designation{';
	if ($cricket_league_pro_our_team_designation_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_team_designation_color) . ' ;';
	}
	if ($cricket_league_pro_our_team_designation_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_our_team_designation_font_family) . ' ;';
	}
	if ($cricket_league_pro_our_team_designation_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_our_team_designation_font_size) . 'px ;';
	}
	if ($cricket_league_pro_our_team_designation_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_our_team_designation_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
$cricket_league_pro_our_team_team_social_icon_color = get_theme_mod('cricket_league_pro_our_team_team_social_icon_color');
if ($cricket_league_pro_our_team_team_social_icon_color != false) {
	$custom_css .= 'section#Our-team i.fab::before{';
	if ($cricket_league_pro_our_team_team_social_icon_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_team_team_social_icon_color) . ' ;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_our_team_team_social_icon_hover_color = get_theme_mod('cricket_league_pro_our_team_team_social_icon_hover_color');
if ($cricket_league_pro_our_team_team_social_icon_hover_color != false) {
	$custom_css .= 'section#Our-team .social-media-links a:hover i.fab::before{';
	if ($cricket_league_pro_our_team_team_social_icon_hover_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_our_team_team_social_icon_hover_color) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_our_team_card_bg_color = get_theme_mod('cricket_league_pro_our_team_card_bg_color');

if ($cricket_league_pro_our_team_card_bg_color != false) {
	$custom_css .= '.team-card{';
	if ($cricket_league_pro_our_team_card_bg_color != false) {
		$custom_css .= 'background-color: ' . esc_html($cricket_league_pro_our_team_card_bg_color) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_GetInTouch_heading_tagline_color = get_theme_mod('cricket_league_pro_GetInTouch_heading_tagline_color');
$cricket_league_pro_GetInTouch_heading_tagline_font_size = get_theme_mod('cricket_league_pro_GetInTouch_heading_tagline_font_size');
$cricket_league_pro_GetInTouch_heading_tagline_font_family = get_theme_mod('cricket_league_pro_GetInTouch_heading_tagline_font_family');
$cricket_league_pro_GetInTouch_heading_tagline_font_weight = get_theme_mod('cricket_league_pro_GetInTouch_heading_tagline_font_weight');


if ($cricket_league_pro_GetInTouch_heading_tagline_color != false || $cricket_league_pro_GetInTouch_heading_tagline_font_family != false || $cricket_league_pro_GetInTouch_heading_tagline_font_size != false || $cricket_league_pro_GetInTouch_heading_tagline_font_weight != false) {
	$custom_css .= 'section#GetInTouch .heading-tagline{';
	if ($cricket_league_pro_GetInTouch_heading_tagline_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_GetInTouch_heading_tagline_color) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_heading_tagline_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_GetInTouch_heading_tagline_font_family) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_heading_tagline_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_GetInTouch_heading_tagline_font_size) . 'px ;';
	}
	if ($cricket_league_pro_GetInTouch_heading_tagline_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_GetInTouch_heading_tagline_font_weight) . ' ;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_GetInTouch_heading_color = get_theme_mod('cricket_league_pro_GetInTouch_heading_color');
$cricket_league_pro_GetInTouch_heading_font_size = get_theme_mod('cricket_league_pro_GetInTouch_heading_font_size');
$cricket_league_pro_GetInTouch_heading_font_family = get_theme_mod('cricket_league_pro_GetInTouch_heading_font_family');
$cricket_league_pro_GetInTouch_heading_font_weight = get_theme_mod('cricket_league_pro_GetInTouch_heading_font_weight');


if ($cricket_league_pro_GetInTouch_heading_color != false || $cricket_league_pro_GetInTouch_heading_font_family != false || $cricket_league_pro_GetInTouch_heading_font_size != false || $cricket_league_pro_GetInTouch_heading_font_weight != false) {
	$custom_css .= 'section#GetInTouch h2{';
	if ($cricket_league_pro_GetInTouch_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_GetInTouch_heading_color) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_GetInTouch_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_GetInTouch_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_GetInTouch_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_GetInTouch_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_GetInTouch_section_desc_color = get_theme_mod('cricket_league_pro_GetInTouch_section_desc_color');
$cricket_league_pro_GetInTouch_section_desc_font_size = get_theme_mod('cricket_league_pro_GetInTouch_section_desc_font_size');
$cricket_league_pro_GetInTouch_section_desc_font_family = get_theme_mod('cricket_league_pro_GetInTouch_section_desc_font_family');
$cricket_league_pro_GetInTouch_section_desc_font_weight = get_theme_mod('cricket_league_pro_GetInTouch_section_desc_font_weight');


if ($cricket_league_pro_GetInTouch_section_desc_color != false || $cricket_league_pro_GetInTouch_section_desc_font_family != false || $cricket_league_pro_GetInTouch_section_desc_font_size != false || $cricket_league_pro_GetInTouch_section_desc_font_weight != false) {
	$custom_css .= '.GetInTouch.heading p.section-desc{';
	if ($cricket_league_pro_GetInTouch_section_desc_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_GetInTouch_section_desc_color) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_section_desc_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_GetInTouch_section_desc_font_family) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_section_desc_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_GetInTouch_section_desc_font_size) . 'px ;';
	}
	if ($cricket_league_pro_GetInTouch_section_desc_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_GetInTouch_section_desc_font_weight) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_GetInTouch_support_text_color = get_theme_mod('cricket_league_pro_GetInTouch_support_text_color');
$cricket_league_pro_GetInTouch_support_text_font_size = get_theme_mod('cricket_league_pro_GetInTouch_support_text_font_size');
$cricket_league_pro_GetInTouch_support_text_font_family = get_theme_mod('cricket_league_pro_GetInTouch_support_text_font_family');
$cricket_league_pro_GetInTouch_support_text_font_weight = get_theme_mod('cricket_league_pro_GetInTouch_support_text_font_weight');


if ($cricket_league_pro_GetInTouch_support_text_color != false || $cricket_league_pro_GetInTouch_support_text_font_family != false || $cricket_league_pro_GetInTouch_support_text_font_size != false || $cricket_league_pro_GetInTouch_support_text_font_weight != false) {
	$custom_css .= '.support-para{';
	if ($cricket_league_pro_GetInTouch_support_text_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_GetInTouch_support_text_color) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_support_text_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_GetInTouch_support_text_font_family) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_support_text_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_GetInTouch_support_text_font_size) . 'px ;';
	}
	if ($cricket_league_pro_GetInTouch_support_text_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_GetInTouch_support_text_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_GetInTouch_support_contact_number_color = get_theme_mod('cricket_league_pro_GetInTouch_support_contact_number_color');
$cricket_league_pro_GetInTouch_support_contact_number_font_size = get_theme_mod('cricket_league_pro_GetInTouch_support_contact_number_font_size');
$cricket_league_pro_GetInTouch_support_contact_number_font_family = get_theme_mod('cricket_league_pro_GetInTouch_support_contact_number_font_family');
$cricket_league_pro_GetInTouch_support_contact_number_font_weight = get_theme_mod('cricket_league_pro_GetInTouch_support_contact_number_font_weight');


if ($cricket_league_pro_GetInTouch_support_contact_number_color != false || $cricket_league_pro_GetInTouch_support_contact_number_font_family != false || $cricket_league_pro_GetInTouch_support_contact_number_font_size != false || $cricket_league_pro_GetInTouch_support_contact_number_font_weight != false) {
	$custom_css .= '.support-box a{';
	if ($cricket_league_pro_GetInTouch_support_contact_number_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_GetInTouch_support_contact_number_color) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_support_contact_number_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_GetInTouch_support_contact_number_font_family) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_support_contact_number_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_GetInTouch_support_contact_number_font_size) . 'px ;';
	}
	if ($cricket_league_pro_GetInTouch_support_contact_number_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_GetInTouch_support_contact_number_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_GetInTouch_column_bgcolor = get_theme_mod('cricket_league_pro_GetInTouch_column_bgcolor');

if ($cricket_league_pro_GetInTouch_column_bgcolor != false) {
	$custom_css .= '.GetInTouch_wrapper,section#GetInTouch::after{';
	if ($cricket_league_pro_GetInTouch_column_bgcolor != false) {
		$custom_css .= 'background-color: ' . esc_html($cricket_league_pro_GetInTouch_column_bgcolor) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_GetInTouch_GetInTouch_feature_description_color = get_theme_mod('cricket_league_pro_GetInTouch_GetInTouch_feature_description_color');
$cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_size = get_theme_mod('cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_size');
$cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_family = get_theme_mod('cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_family');
$cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_weight = get_theme_mod('cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_weight');


if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_color != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_family != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_size != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_weight != false) {
	$custom_css .= '.GetInTouch-features .desc{';
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_description_color) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_family) . ' ;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_size) . 'px ;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_GetInTouch_GetInTouch_feature_title_color = get_theme_mod('cricket_league_pro_GetInTouch_GetInTouch_feature_title_color');
$cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_size = get_theme_mod('cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_size');
$cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_family = get_theme_mod('cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_family');
$cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_weight = get_theme_mod('cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_weight');


if ($cricket_league_pro_GetInTouch_GetInTouch_feature_title_color != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_family != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_size != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_weight != false) {
	$custom_css .= '.feature-info p{';
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_title_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_title_color) . ' !important;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_family) . ' !important;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_title_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}
...
if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_color != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_family != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_size != false || $cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_weight != false) {
	$custom_css .= '.desc{';
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_description_color) . ' !important;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_family) . ' !important;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_GetInTouch_GetInTouch_feature_description_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_faq_faq_feature_heading_tagline_color = get_theme_mod('cricket_league_pro_faq_faq_feature_heading_tagline_color');
$cricket_league_pro_faq_faq_feature_heading_tagline_font_size = get_theme_mod('cricket_league_pro_faq_faq_feature_heading_tagline_font_size');
$cricket_league_pro_faq_faq_feature_heading_tagline_font_family = get_theme_mod('cricket_league_pro_faq_faq_feature_heading_tagline_font_family');
$cricket_league_pro_faq_faq_feature_heading_tagline_font_weight = get_theme_mod('cricket_league_pro_faq_faq_feature_heading_tagline_font_weight');


if ($cricket_league_pro_faq_faq_feature_heading_tagline_color != false || $cricket_league_pro_faq_faq_feature_heading_tagline_font_family != false || $cricket_league_pro_faq_faq_feature_heading_tagline_font_size != false || $cricket_league_pro_faq_faq_feature_heading_tagline_font_weight != false) {
	$custom_css .= 'section#faq .heading-tagline{';
	if ($cricket_league_pro_faq_faq_feature_heading_tagline_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_faq_faq_feature_heading_tagline_color) . ' !important;';
	}
	if ($cricket_league_pro_faq_faq_feature_heading_tagline_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_faq_faq_feature_heading_tagline_font_family) . ' !important;';
	}
	if ($cricket_league_pro_faq_faq_feature_heading_tagline_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_faq_faq_feature_heading_tagline_font_size) . 'px !important;';
	}
	if ($cricket_league_pro_faq_faq_feature_heading_tagline_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_faq_faq_feature_heading_tagline_font_weight) . ' !important;';
	}
	$custom_css .= '}';
}
...
if ($cricket_league_pro_footer_headings_color != false || $cricket_league_pro_footer_headings_font_family != false || $cricket_league_pro_footer_headings_font_size != false || $cricket_league_pro_footer_headings_font_weight != false) {
	$custom_css .= '#footer h3.widget-title{';
	if ($cricket_league_pro_footer_headings_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_footer_headings_color) . ' ;';
	}
	if ($cricket_league_pro_footer_headings_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_footer_headings_font_family) . ' ;';
	}
	if ($cricket_league_pro_footer_headings_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_footer_headings_font_size) . 'px ;';
	}
	if ($cricket_league_pro_footer_headings_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_footer_headings_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_getaquote_heading_tagline_color = get_theme_mod('cricket_league_pro_getaquote_heading_tagline_color');
$cricket_league_pro_getaquote_heading_tagline_font_size = get_theme_mod('cricket_league_pro_getaquote_heading_tagline_font_size');
$cricket_league_pro_getaquote_heading_tagline_font_family = get_theme_mod('cricket_league_pro_getaquote_heading_tagline_font_family');
$cricket_league_pro_getaquote_heading_tagline_font_weight = get_theme_mod('cricket_league_pro_getaquote_heading_tagline_font_weight');


if ($cricket_league_pro_getaquote_heading_tagline_color != false || $cricket_league_pro_getaquote_heading_tagline_font_family != false || $cricket_league_pro_getaquote_heading_tagline_font_size != false || $cricket_league_pro_getaquote_heading_tagline_font_weight != false) {
	$custom_css .= 'section.getAquote .heading-tagline{';
	if ($cricket_league_pro_getaquote_heading_tagline_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_getaquote_heading_tagline_color) . ' ;';
	}
	if ($cricket_league_pro_getaquote_heading_tagline_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_getaquote_heading_tagline_font_family) . ' ;';
	}
	if ($cricket_league_pro_getaquote_heading_tagline_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_getaquote_heading_tagline_font_size) . 'px ;';
	}
	if ($cricket_league_pro_getaquote_heading_tagline_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_getaquote_heading_tagline_font_weight) . ' ;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_getaquote_heading_color = get_theme_mod('cricket_league_pro_getaquote_heading_color');
$cricket_league_pro_getaquote_heading_font_size = get_theme_mod('cricket_league_pro_getaquote_heading_font_size');
$cricket_league_pro_getaquote_heading_font_family = get_theme_mod('cricket_league_pro_getaquote_heading_font_family');
$cricket_league_pro_getaquote_heading_font_weight = get_theme_mod('cricket_league_pro_getaquote_heading_font_weight');


if ($cricket_league_pro_getaquote_heading_color != false || $cricket_league_pro_getaquote_heading_font_family != false || $cricket_league_pro_getaquote_heading_font_size != false || $cricket_league_pro_getaquote_heading_font_weight != false) {
	$custom_css .= 'section.getAquote .heading h2{';
	if ($cricket_league_pro_getaquote_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_getaquote_heading_color) . ' ;';
	}
	if ($cricket_league_pro_getaquote_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_getaquote_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_getaquote_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_getaquote_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_getaquote_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_getaquote_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_getaquote_option_content_color = get_theme_mod('cricket_league_pro_getaquote_option_content_color');
$cricket_league_pro_getaquote_option_content_font_size = get_theme_mod('cricket_league_pro_getaquote_option_content_font_size');
$cricket_league_pro_getaquote_option_content_font_family = get_theme_mod('cricket_league_pro_getaquote_option_content_font_family');
$cricket_league_pro_getaquote_option_content_font_weight = get_theme_mod('cricket_league_pro_getaquote_option_content_font_weight');


if ($cricket_league_pro_getaquote_option_content_color != false || $cricket_league_pro_getaquote_option_content_font_family != false || $cricket_league_pro_getaquote_option_content_font_size != false || $cricket_league_pro_getaquote_option_content_font_weight != false) {
	$custom_css .= '.contact-info a{';
	if ($cricket_league_pro_getaquote_option_content_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_getaquote_option_content_color) . ' ;';
	}
	if ($cricket_league_pro_getaquote_option_content_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_getaquote_option_content_font_family) . ' ;';
	}
	if ($cricket_league_pro_getaquote_option_content_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_getaquote_option_content_font_size) . 'px ;';
	}
	if ($cricket_league_pro_getaquote_option_content_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_getaquote_option_content_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
$cricket_league_pro_getaquotetion_bgcolor = get_theme_mod('cricket_league_pro_getaquotetion_bgcolor');

if ($cricket_league_pro_getaquotetion_bgcolor != false) {
	$custom_css .= '.contact-option{';
	if ($cricket_league_pro_getaquotetion_bgcolor != false) {
		$custom_css .= 'background-color:' . esc_html($cricket_league_pro_getaquotetion_bgcolor) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_getaquote_option_title_color = get_theme_mod('cricket_league_pro_getaquote_option_title_color');
$cricket_league_pro_getaquote_option_title_font_size = get_theme_mod('cricket_league_pro_getaquote_option_title_font_size');
$cricket_league_pro_getaquote_option_title_font_family = get_theme_mod('cricket_league_pro_getaquote_option_title_font_family');
$cricket_league_pro_getaquote_option_title_font_weight = get_theme_mod('cricket_league_pro_getaquote_option_title_font_weight');


if ($cricket_league_pro_getaquote_option_title_color != false || $cricket_league_pro_getaquote_option_title_font_family != false || $cricket_league_pro_getaquote_option_title_font_size != false || $cricket_league_pro_getaquote_option_title_font_weight != false) {
	$custom_css .= 'p.contact-label{';
	if ($cricket_league_pro_getaquote_option_title_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_getaquote_option_title_color) . ' ;';
	}
	if ($cricket_league_pro_getaquote_option_title_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_getaquote_option_title_font_family) . ' ;';
	}
	if ($cricket_league_pro_getaquote_option_title_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_getaquote_option_title_font_size) . 'px ;';
	}
	if ($cricket_league_pro_getaquote_option_title_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_getaquote_option_title_font_weight) . ' ;';
		$custom_css .= '}';
	}
}
...
$cricket_league_pro_getaquote_form_heading_tag_color = get_theme_mod('cricket_league_pro_getaquote_form_heading_tag_color');
$cricket_league_pro_getaquote_form_heading_tag_font_size = get_theme_mod('cricket_league_pro_getaquote_form_heading_tag_font_size');
$cricket_league_pro_getaquote_form_heading_tag_font_family = get_theme_mod('cricket_league_pro_getaquote_form_heading_tag_font_family');
$cricket_league_pro_getaquote_form_heading_tag_font_weight = get_theme_mod('cricket_league_pro_getaquote_form_heading_tag_font_weight');


if ($cricket_league_pro_getaquote_form_heading_tag_color != false || $cricket_league_pro_getaquote_form_heading_tag_font_family != false || $cricket_league_pro_getaquote_form_heading_tag_font_size != false || $cricket_league_pro_getaquote_form_heading_tag_font_weight != false) {
	$custom_css .= 'span.quoteTagline{';
	if ($cricket_league_pro_getaquote_form_heading_tag_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_getaquote_form_heading_tag_color) . ' ;';
	}
	if ($cricket_league_pro_getaquote_form_heading_tag_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_getaquote_form_heading_tag_font_family) . ' ;';
	}
	if ($cricket_league_pro_getaquote_form_heading_tag_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_getaquote_form_heading_tag_font_size) . 'px ;';
	}
	if ($cricket_league_pro_getaquote_form_heading_tag_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_getaquote_form_heading_tag_font_weight) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_getaquote_form_heading_color = get_theme_mod('cricket_league_pro_getaquote_form_heading_color');
$cricket_league_pro_getaquote_form_heading_font_size = get_theme_mod('cricket_league_pro_getaquote_form_heading_font_size');
$cricket_league_pro_getaquote_form_heading_font_family = get_theme_mod('cricket_league_pro_getaquote_form_heading_font_family');
$cricket_league_pro_getaquote_form_heading_font_weight = get_theme_mod('cricket_league_pro_getaquote_form_heading_font_weight');


if ($cricket_league_pro_getaquote_form_heading_color != false || $cricket_league_pro_getaquote_form_heading_font_family != false || $cricket_league_pro_getaquote_form_heading_font_size != false || $cricket_league_pro_getaquote_form_heading_font_weight != false) {
	$custom_css .= '.quote-heading h4{';
	if ($cricket_league_pro_getaquote_form_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_getaquote_form_heading_color) . ' ;';
	}
	if ($cricket_league_pro_getaquote_form_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_getaquote_form_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_getaquote_form_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_getaquote_form_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_getaquote_form_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_getaquote_form_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_services_single_heading_color = get_theme_mod('cricket_league_pro_services_single_heading_color');
$cricket_league_pro_services_single_heading_font_size = get_theme_mod('cricket_league_pro_services_single_heading_font_size');
$cricket_league_pro_services_single_heading_font_family = get_theme_mod('cricket_league_pro_services_single_heading_font_family');
$cricket_league_pro_services_single_heading_font_weight = get_theme_mod('cricket_league_pro_services_single_heading_font_weight');


if ($cricket_league_pro_services_single_heading_color != false || $cricket_league_pro_services_single_heading_font_family != false || $cricket_league_pro_services_single_heading_font_size != false || $cricket_league_pro_services_single_heading_font_weight != false) {
	$custom_css .= 'section#service-single div#service_single h2{';
	if ($cricket_league_pro_services_single_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_services_single_heading_color) . ' ;';
	}
	if ($cricket_league_pro_services_single_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_services_single_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_services_single_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_services_single_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_services_single_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_services_single_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_services_single_body_text_color = get_theme_mod('cricket_league_pro_services_single_body_text_color');
$cricket_league_pro_services_single_body_text_font_size = get_theme_mod('cricket_league_pro_services_single_body_text_font_size');
$cricket_league_pro_services_single_body_text_font_family = get_theme_mod('cricket_league_pro_services_single_body_text_font_family');
$cricket_league_pro_services_single_body_text_font_weight = get_theme_mod('cricket_league_pro_services_single_body_text_font_weight');


if ($cricket_league_pro_services_single_body_text_color != false || $cricket_league_pro_services_single_body_text_font_family != false || $cricket_league_pro_services_single_body_text_font_size != false || $cricket_league_pro_services_single_body_text_font_weight != false) {
	$custom_css .= '.services-para1, #service-single #service_single p,ul.featured-list li{';
	if ($cricket_league_pro_services_single_body_text_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_services_single_body_text_color) . ' ;';
	}
	if ($cricket_league_pro_services_single_body_text_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_services_single_body_text_font_family) . ' ;';
	}
	if ($cricket_league_pro_services_single_body_text_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_services_single_body_text_font_size) . 'px ;';
	}
	if ($cricket_league_pro_services_single_body_text_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_services_single_body_text_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
$cricket_league_pro_services_single_sub_heading_color = get_theme_mod('cricket_league_pro_services_single_sub_heading_color');
$cricket_league_pro_services_single_sub_heading_font_size = get_theme_mod('cricket_league_pro_services_single_sub_heading_font_size');
$cricket_league_pro_services_single_sub_heading_font_family = get_theme_mod('cricket_league_pro_services_single_sub_heading_font_family');
$cricket_league_pro_services_single_sub_heading_font_weight = get_theme_mod('cricket_league_pro_services_single_sub_heading_font_weight');


if ($cricket_league_pro_services_single_sub_heading_color != false || $cricket_league_pro_services_single_sub_heading_font_family != false || $cricket_league_pro_services_single_sub_heading_font_size != false || $cricket_league_pro_services_single_sub_heading_font_weight != false) {
	$custom_css .= '.title,section#service-single h3,.section#service-single h4{';
	if ($cricket_league_pro_services_single_sub_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_services_single_sub_heading_color) . ' ;';
	}
	if ($cricket_league_pro_services_single_sub_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_services_single_sub_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_services_single_sub_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_services_single_sub_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_services_single_sub_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_services_single_sub_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_services_single_counter_heading_color = get_theme_mod('cricket_league_pro_services_single_counter_heading_color');
$cricket_league_pro_services_single_counter_heading_font_size = get_theme_mod('cricket_league_pro_services_single_counter_heading_font_size');
$cricket_league_pro_services_single_counter_heading_font_family = get_theme_mod('cricket_league_pro_services_single_counter_heading_font_family');
$cricket_league_pro_services_single_counter_heading_font_weight = get_theme_mod('cricket_league_pro_services_single_counter_heading_font_weight');


if ($cricket_league_pro_services_single_counter_heading_color != false || $cricket_league_pro_services_single_counter_heading_font_family != false || $cricket_league_pro_services_single_counter_heading_font_size != false || $cricket_league_pro_services_single_counter_heading_font_weight != false) {
	$custom_css .= 'h5.counter-title{';
	if ($cricket_league_pro_services_single_counter_heading_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_services_single_counter_heading_color) . ' ;';
	}
	if ($cricket_league_pro_services_single_counter_heading_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_services_single_counter_heading_font_family) . ' ;';
	}
	if ($cricket_league_pro_services_single_counter_heading_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_services_single_counter_heading_font_size) . 'px ;';
	}
	if ($cricket_league_pro_services_single_counter_heading_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_services_single_counter_heading_font_weight) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_services_single_counter_count_color = get_theme_mod('cricket_league_pro_services_single_counter_count_color');
$cricket_league_pro_services_single_counter_count_font_size = get_theme_mod('cricket_league_pro_services_single_counter_count_font_size');
$cricket_league_pro_services_single_counter_count_font_family = get_theme_mod('cricket_league_pro_services_single_counter_count_font_family');
$cricket_league_pro_services_single_counter_count_font_weight = get_theme_mod('cricket_league_pro_services_single_counter_count_font_weight');


if ($cricket_league_pro_services_single_counter_count_color != false || $cricket_league_pro_services_single_counter_count_font_family != false || $cricket_league_pro_services_single_counter_count_font_size != false || $cricket_league_pro_services_single_counter_count_font_weight != false) {
	$custom_css .= 'span.counter-number{';
	if ($cricket_league_pro_services_single_counter_count_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_services_single_counter_count_color) . ' ;';
	}
	if ($cricket_league_pro_services_single_counter_count_font_family != false) {
		$custom_css .= 'font-family:' . esc_html($cricket_league_pro_services_single_counter_count_font_family) . ' ;';
	}
	if ($cricket_league_pro_services_single_counter_count_font_size != false) {
		$custom_css .= 'font-size:' . esc_html($cricket_league_pro_services_single_counter_count_font_size) . 'px ;';
	}
	if ($cricket_league_pro_services_single_counter_count_font_weight != false) {
		$custom_css .= 'font-weight:' . esc_html($cricket_league_pro_services_single_counter_count_font_weight) . ' ;';
	}
	$custom_css .= '}';
}
...
if ($cricket_league_pro_404_page_button_color != false || $cricket_league_pro_404_page_button_font_family != false || $cricket_league_pro_404_page_button_font_size != false || $cricket_league_pro_404_page_sub_button_font_weight != false || $cricket_league_pro_404_page_button_bg_color != false) {
	$custom_css .= 'section.content_page.error-page a.btn.black{';
...
$cricket_league_pro_genral_heading_decoration_section = get_theme_mod('cricket_league_pro_genral_heading_decoration_section');

if ($cricket_league_pro_genral_heading_decoration_section != false) {
	$custom_css .= '.home h1::after, .home h2::after, .recent-posts h2::after, section#About-us h2::after, .best-left h3::after, .getAquote h2::after{';
	if ($cricket_league_pro_genral_heading_decoration_section != false) {
...
$cricket_league_pro_about_bgimage_setting = get_theme_mod('cricket_league_pro_about_bgimage_setting');

if ($cricket_league_pro_about_bgimage_setting != false) {
	$custom_css .= '#About-us{';
	if ($cricket_league_pro_about_bgimage_setting != false) {
		$custom_css .= 'background-attachment:' . esc_html($cricket_league_pro_about_bgimage_setting) . ' ;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_our_services_bgimage_setting = get_theme_mod('cricket_league_pro_our_services_bgimage_setting');


if ($cricket_league_pro_our_services_bgimage_setting != false) {
	$custom_css .= 'section#services-us{';
	if ($cricket_league_pro_our_services_bgimage_setting != false) {
		$custom_css .= 'background-attachment:' . esc_html($cricket_league_pro_our_services_bgimage_setting) . ' ;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_order_tracking_bgimage_setting = get_theme_mod('cricket_league_pro_order_tracking_bgimage_setting');


if ($cricket_league_pro_order_tracking_bgimage_setting != false) {
	$custom_css .= 'section#order_tracking-us{';
	if ($cricket_league_pro_order_tracking_bgimage_setting != false) {
		$custom_css .= 'background-attachment:' . esc_html($cricket_league_pro_order_tracking_bgimage_setting) . ' ;';
	}
	$custom_css .= '}';
}

$cricket_league_pro_steps_bgimage_setting = get_theme_mod('cricket_league_pro_steps_bgimage_setting');


if ($cricket_league_pro_steps_bgimage_setting != false) {
	$custom_css .= 'section#steps_sec-us{';
	if ($cricket_league_pro_steps_bgimage_setting != false) {
		$custom_css .= 'background-attachment:' . esc_html($cricket_league_pro_steps_bgimage_setting) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_pricing_bg_image_attachment = get_theme_mod('cricket_league_pro_pricing_bg_image_attachment');


if ($cricket_league_pro_pricing_bg_image_attachment != false) {
	$custom_css .= 'section#pricing_sec-us{';
	if ($cricket_league_pro_pricing_bg_image_attachment != false) {
		$custom_css .= 'background-attachment:' . esc_html($cricket_league_pro_pricing_bg_image_attachment) . ' ;';
	}
	$custom_css .= '}';
}


$cricket_league_pro_whychooseus_bg_image_attachment = get_theme_mod('cricket_league_pro_whychooseus_bg_image_attachment');


if ($cricket_league_pro_whychooseus_bg_image_attachment != false) {
	$custom_css .= 'section#whyChooseUs{';
	if ($cricket_league_pro_whychooseus_bg_image_attachment != false) {
		$custom_css .= 'background-attachment:' . esc_html($cricket_league_pro_whychooseus_bg_image_attachment) . ' ;';
	}
	$custom_css .= '}';
}
$cricket_league_pro_GetInTouch_bg_image_attachment = get_theme_mod('cricket_league_pro_GetInTouch_bg_image_attachment');


if ($cricket_league_pro_GetInTouch_bg_image_attachment != false) {
	$custom_css .= 'section#GetInTouch{';
	if ($cricket_league_pro_GetInTouch_bg_image_attachment != false) {
		$custom_css .= 'background-attachment:' . esc_html($cricket_league_pro_GetInTouch_bg_image_attachment) . ' ;';
	}
	$custom_css .= '}';
}
...
if ($cricket_league_pro_topbar_icon_size != false || $cricket_league_pro_header_social_icon_color != false) {
	$custom_css .= '.socialbox a i::before{
...
if ($cricket_league_pro_section_slider_padding_top != false) {
	...
	if ($cricket_league_pro_section_slider_padding_top != false) {
		$custom_css .= 'padding-top: ' . esc_html($cricket_league_pro_section_slider_padding_top) . 'px ;';
	}
	$custom_css .= '}';
}
...
/*-------------------Primary Color --------------------*/
$custom_css .= ':root{
	#FF6F00: ' . esc_html($cricket_league_pro_hi_first_color) . ' !important;
...
if ($cricket_league_pro_h2_font_family != false || $cricket_league_pro_h2_color != false || $cricket_league_pro_h2_font_size != false || $cricket_league_pro_h2_font_weight != false) {
	...
	if ($cricket_league_pro_h2_font_family != false) {
		$custom_css .= 'font-family: ' . esc_html($cricket_league_pro_h2_font_family) . ';';
	}
	if ($cricket_league_pro_h2_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_h2_color) . ';';
	}
	if ($cricket_league_pro_h2_font_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_h2_font_size) . 'px ;';
	}
	if ($cricket_league_pro_h2_font_weight != false) {
		$custom_css .= 'font-weight: ' . esc_html($cricket_league_pro_h2_font_weight) . ';';
	}
	$custom_css .= '}';
}
/*-------------------h3-----------------------*/
if ($cricket_league_pro_h3_font_family != false || $cricket_league_pro_h3_color != false || $cricket_league_pro_h3_font_size != false || $cricket_league_pro_h3_font_weight != false) {
	...
	if ($cricket_league_pro_h3_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_h3_color) . ';';
	}
	if ($cricket_league_pro_h3_font_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_h3_font_size) . 'px;';
	}
	if ($cricket_league_pro_h3_font_weight != false) {
		$custom_css .= 'font-weight: ' . esc_html($cricket_league_pro_h3_font_weight) . ';';
	}
	$custom_css .= '}';
...
if ($cricket_league_pro_h4_font_family != false || $cricket_league_pro_h4_color != false || $cricket_league_pro_h4_font_size != false || $cricket_league_pro_h4_font_weight != false) {
	...
	if ($cricket_league_pro_h4_font_family != false) {
		$custom_css .= 'font-family: ' . esc_html($cricket_league_pro_h4_font_family) . ';';
	}
	if ($cricket_league_pro_h4_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_h4_color) . ';';
	}
	if ($cricket_league_pro_h4_font_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_h4_font_size) . 'px;';
	}
	if ($cricket_league_pro_h4_font_weight != false) {
		$custom_css .= 'font-weight: ' . esc_html($cricket_league_pro_h4_font_weight) . ';';
	}
	$custom_css .= '}';
	$custom_css .= '}';
}
if ($cricket_league_pro_h5_font_family != false || $cricket_league_pro_h5_color != false || $cricket_league_pro_h5_font_size != false || $cricket_league_pro_h5_font_weight != false) {
	...
	if ($cricket_league_pro_h5_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_h5_color) . ';';
	}
	if ($cricket_league_pro_h5_font_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_h5_font_size) . 'px ;';
	}
	if ($cricket_league_pro_h5_font_weight != false) {
		$custom_css .= 'font-weight: ' . esc_html($cricket_league_pro_h5_font_weight) . ';';
	}
	$custom_css .= '}';
}
if ($cricket_league_pro_h6_font_family != false || $cricket_league_pro_h6_color != false || $cricket_league_pro_h6_font_size != false || $cricket_league_pro_h6_font_weight != false) {
	...
	if ($cricket_league_pro_h6_font_family != false) {
		$custom_css .= 'font-family: ' . esc_html($cricket_league_pro_h6_font_family) . ';';
	}
	if ($cricket_league_pro_h6_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_h6_color) . ';';
	}
	if ($cricket_league_pro_h6_font_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_h6_font_size) . 'px;';
	}
	if ($cricket_league_pro_h6_font_weight != false) {
		$custom_css .= 'font-weight: ' . esc_html($cricket_league_pro_h6_font_weight) . ';';
	}
	$custom_css .= '}';
}
if ($cricket_league_pro_paragarpah_font_family != false || $cricket_league_pro_para_color != false || $cricket_league_pro_para_font_size != false || $cricket_league_pro_para_font_weight != false) {
	...
	if ($cricket_league_pro_paragarpah_font_family != false) {
		$custom_css .= 'font-family: ' . esc_html($cricket_league_pro_paragarpah_font_family) . ';';
	}
	if ($cricket_league_pro_para_color != false) {
		$custom_css .= 'color: ' . esc_html($cricket_league_pro_para_color) . ';';
	}
	if ($cricket_league_pro_para_font_size != false) {
		$custom_css .= 'font-size: ' . esc_html($cricket_league_pro_para_font_size) . 'px;';
	}
	if ($cricket_league_pro_para_font_weight != false) {
		$custom_css .= 'font-weight: ' . esc_html($cricket_league_pro_para_font_weight) . ';';
	}
	$custom_css .= '}';
}
...
if ($cricket_league_pro_slider_btntext_color != false || $cricket_league_pro_slider_btntext_font_family != false || $cricket_league_pro_slider_btntext_font_size != false || $cricket_league_pro_slider_btntext_font_weight != false || $cricket_league_pro_slider_btn_bgcolor_one != false) {
	...
	if ($cricket_league_pro_slider_btn_bgcolor_one != false || $cricket_league_pro_slider_btn_bgcolor_two != false)
		$custom_css .= 'background: ' . esc_html($cricket_league_pro_slider_btn_bgcolor_one) . ';';
	$custom_css .= '}';
}
$cricket_league_pro_header_bat_image = get_theme_mod('cricket_league_pro_header_bat_image');
...
if ($cricket_league_pro_timer_text_color != false || $cricket_league_pro_timer_text_font_family != false || $cricket_league_pro_timer_text_font_size != false || $cricket_league_pro_timer_text_font_weight != false || $cricket_league_pro_slider_btn_bgcolor_one != false) {
	...
	if ($cricket_league_pro_slider_btn_bgcolor_one != false || $cricket_league_pro_slider_btn_bgcolor_two != false)
		$custom_css .= 'background: ' . esc_html($cricket_league_pro_slider_btn_bgcolor_one) . ' !important;';
	$custom_css .= '}';
}
