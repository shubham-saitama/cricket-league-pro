...
if ($product->is_in_stock()): ?>
	...
	<form class="cart"
		...
		<div class="price-custom-wrapper">
			...
			<div class="single-pro-btn d-flex pb-3" style="position: relative;border-bottom: 2px solid #dedada;">
				<button type="submit" name="add-to-cart" value="<?php echo esc_attr($product->get_id()); ?>"
					class="single_add_to_cart_button button alt ms-3" id="buy_now_button">
					<?php echo esc_html('Add To Bag'); ?>
				</button>
		...
		<div class="row pb-lg-2 pb-3 pt-lg-4 pt-sm-3 pt-3 single-shipping-box">
			<?php
			for ($i = 1; $i <= 4; $i++) { ?>
